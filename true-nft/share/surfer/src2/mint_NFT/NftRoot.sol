...
//    function mintNft(uint64 creationDate, string comment, address owner) public onlyOwner {
    function mintNft(uint64 creationDate, string comment, string comment1, string comment2, string comment3, address owner) public {
...
//        PRINT============================================================================================================
        TvmCell stateData = _buildDataState(codeData, 16+_totalMinted);
        new Data
