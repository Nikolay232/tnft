...
//    }
    ...
    function nftParamsSetOwnerAddress(address value) public {
        ...
        Terminal.input(tvm.functionId(nftParamsSetComment1), "Enter comment1:", false);
        Terminal.input(tvm.functionId(nftParamsSetComment2), "Enter comment2:", false);
        Terminal.input(tvm.functionId(nftParamsSetComment3), "Enter comment3:", false);
    }
    function nftParamsSetComment(string value) public {
        _nftParams.comment = value;
//        this.nftParamsInputOwnerAddress1();
//        this.deployNftStep1();
    }function nftParamsSetComment1(string value) public {
        _nftParams.comment1 = value;
//        this.nftParamsInputOwnerAddress1();
//        this.deployNftStep1();
    }function nftParamsSetComment2(string value) public {
        _nftParams.comment2 = value;
//        this.nftParamsInputOwnerAddress1();
//        this.deployNftStep1();
    }
    function nftParamsSetComment3(string value) public {
        _nftParams.comment3 = value;
//        this.nftParamsInputOwnerAddress1();
        this.deployNftStep1();
    }

//    function nftParamsInputOwnerAddress1() public {
////        index;
//        AddressInput.get(tvm.functionId(nftParamsSetOwnerAddress1), "Enter owner address:");
//    }
//    function nftParamsSetOwnerAddress1(address value) public {
//        Terminal.input(tvm.functionId(nftParamsSetComment1), "Enter comment1:", false);
//    }
//    function nftParamsSetComment1(string value) public {
//        _nftParams.comment1 = value;
...
//    }
    ...
    function deployNftStep2() public {
        ...
        ConfirmInput.get(tvm.functionId(deployNftStep3), "Sign and deploy NFT?");
    }
